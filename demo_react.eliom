    ...
    [%client
      (Fiber.fork
         ...
         (fun () ->
            ...
            Js_of_ocaml_eio.Eio_js_events.clicks btn (fun _ _ ->
...
let%shared () =
  Project_name_base.App.register ~service:Demo_services.demo_react
    ( Project_name_page.Opt.connected_page @@ fun myid_o () () ->
      let p = page () in
      Project_name_container.page ~a:[a_class ["os-page-demo-react"]] myid_o p
    )
