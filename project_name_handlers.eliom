...
let upload_user_avatar_handler myid () ((), (cropping, photo)) =
  let avatar_dir =
    List.fold_left Filename.concat
      (List.hd !Project_name_config.avatar_dir)
  ...
  | e ->
      ...
      then
        ...
        then
          ...
          in
          Project_name_base.App.send (Project_name_page.make_page (Os_page.content page))
        else
          let page =
            [ div
                ~a:[a_class ["login-signup-box"]]
...
let%shared settings_handler myid_o () () =
  let%lwt content =
    match myid_o with
    | Some _ -> Project_name_settings.settings_content ()
