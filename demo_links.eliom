...
let%shared page () =
  Lwt.return
    ...
    ; p
        [%i18n
          Demo.services_1
            ~f1:[code [txt "project_name_services.eliom"]]
            ~f2:[code [txt "project_name_handlers.eliom"]]
...
let%shared () =
  Project_name_base.App.register ~service:Demo_services.demo_links
    ( Project_name_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Project_name_container.page ~a:[a_class ["os-page-demo-links"]] myid_o p
    )
