      ...
      (Fiber.fork
         ...
         (fun () ->
            Js_of_ocaml_eio.Eio_js_events.clicks
              (Eliom_content.Html.To_dom.of_element ~%btn) (fun _ _ -> ~%f ()))
       : unit)];
  btn
...
let%shared () =
  Project_name_base.App.register ~service:Demo_services.demo_rpc
    ( Project_name_page.Opt.connected_page @@ fun myid_o () () ->
      let p = page () in
      Project_name_container.page ~a:[a_class ["os-page-demo-rpc"]] myid_o p )
